...
institutions_df<-as.tibble(read.csv(args[2],stringsAsFactors = F)) #read in the csv of accrediated institutions and make it a tibble
...
#Make a unique list of US institutions
