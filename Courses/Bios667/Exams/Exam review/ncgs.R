...
# Data from the NCGS study, Fitzmaurice et al (2011) exercise 5.1 
  
# Q1: Run this file to create the R dataset ncgs 
...
1,  33,  224,  273,  242,  274,   NA, 
1,  34,  307,  252,  316,  258,  283,
1,  35,  313,  300,  313,  317,  397,
1,  36,  231,  252,  267,  299,   NA,  
1,  37,  206,  177,  194,  194,  212,
1,  38,  285,  291,  291,  268,  260,
1,  39,  250,  269,   NA,  NA,    NA,
1,  40,  175,  214,   NA,  NA,    NA,  
1,  41,  201,  219,  220,  NA,    NA,  
1,  42,  268,  296,  314,  330,   NA,  
1,  43,  202,  186,  253,  NA,    NA,  
1,  44,  260,  268,   NA,  NA,    NA,  
1,  45,  209,  207,  167,  NA,    NA,  
1,  46,  197,  218,   NA,  NA,    NA,  
1,  47,  248,  262,   NA,  NA,    NA,  
1,  48,  212,  253,  225,  NA,    NA,  
1,  49,  276,  326,  304,  NA,    NA,  
1,  50,  163,  179,  199,  NA,    NA,  
1,  51,  239,  243,  265,  NA,    NA,  
1,  52,  204,  203,  198,  NA,    NA,  
1,  53,  247,  211,  225,  NA,    NA,  
1,  54,  195,  250,  272,  NA,    NA,  
1,  55,  228,  228,  279,  NA,    NA,  
1,  56,  290,  264,  260,  NA,    NA,  
1,  57,  284,  288,  268,  261,   NA,  
1,  58,  217,  231,  276,  257,   NA,  
1,  59,  209,  200,  269,  233,   NA,  
1,  60,  200,  261,  264,  300,   NA,  
1,  61,  227,  247,   NA,  NA,    220,
1,  62,  193,  189,   NA,  232,  211,
...
2,  95,  172,  180,  216,  183,   NA, 
2,  96,  191,  208,  162,  218,  206,
2,  97,  282,  282,  NA,    NA,   NA, 
2,  98,  213,  249,  219,  209,   NA,  
2,  99,  171,  188,   NA,   NA,   NA,  
2,  100, 242,  268,   NA,   NA,   NA,  
2,  101,  197,  224,  214,  NA,   NA,  
2,  102,  230,  228,  266,  NA,   NA,  
2,  103,  373,  309,  332,  NA,   NA  
), 103, 7, byrow=TRUE)


colnames(raw) <- c('group', 'id', 'y0', 'y1', 'y2', 'y3', 'y4')

ncgs <- as.data.frame(raw)