...
```{r}
tlclong2=tlclong%>%filter(time>1)
tlclong2=tlclong2%>%mutate(week=case_when(time==2~1,time==3~4,time==4~6),time=time-1,week.f = factor(week, c(1,4,6)),change <- y - baseline,cbaseline <- baseline - 26.406)
```
