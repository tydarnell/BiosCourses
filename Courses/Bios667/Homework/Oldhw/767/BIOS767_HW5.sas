...
*transform the data and export for spag-plot in rmark;
...
run;
proc export data=exercise3 
   outfile='\\Client\H$\Desktop\Spring2019\BIOS_767\Homework\HW05\exercise_new2.csv'  
   dbms=csv
   replace;
run;
...
proc mixed data=exercise3;
	class id ;
	model strength = days trt days*trt / s cl chisq outpred=yhat;
